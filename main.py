...
BIN_SIZE = 16
TEST_PATH = 'dataset_60v40/test'
TRAIN_PATH = 'dataset_60v40/train'
...
if __name__ == '__main__':
    ...
    hitung = 0
    for input, prediction, label in zip(test_data, prediction, test_label):
        if prediction != label:
            print('has been classified as ', color_list[prediction], 'and should be ', color_list[label], "| index : ", hitung, "file:", save_img[hitung])
        hitung+=1
